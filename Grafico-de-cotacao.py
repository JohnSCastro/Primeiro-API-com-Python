...
for i in range(tempo):
    x = (valor_periodo[i]['bid'])
    lista.append(float(x))

for i in range(tempo):
    if (dia-1) < 0 and (mes == 1 or mes == 2 or mes == 4 or mes == 6 or mes == 8 or mes == 9 or mes == 11):
        dia = 31
        if mes == 1:
          mes = 12
          data.append(f'{dia}/{mes}')
          dia = dia - 1
        else:
          mes -= 1
          data.append(f'{dia}/{mes}')
    ...
    elif (dia-1) < 0 and (mes == 5 or mes == 7 or mes == 10 or mes == 12):
        dia = 30
        if mes == 1:
          mes = 12
          data.append(f'{dia}/{mes}')
